"""Script to generate a wallpaper of randomly colored Gosper islands."""
...
if __name__ == "__main__":
    ...
    gosper_isle = gosper_island(iterations=2)

    element_paths = [scale(gosper_isle, (ax / sqrt(3), Rational(ay, 2)))]
